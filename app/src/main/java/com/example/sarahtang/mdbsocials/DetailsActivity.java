...
public class DetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = intent.getStringExtra(SocialsAdapter.NAME_KEY);
        ...
        ArrayList<String> resultArray = intent.getStringArrayListExtra(SocialsAdapter.PEOPLE_INTERESTED);
        if (resultArray == null) {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.fabInterested) {
